...
export default class MovieProfileRoute extends Route {
    ...
    async model(params) {
        ...
        //i had to append to the api for movie MPAA ratings
         const response = await fetch('https://api.themoviedb.org/3/movie/' + params.title + '?api_key=4517228c3cc695f9dfa1dcb4c4979152&language=en-US&append_to_response=release_dates');
